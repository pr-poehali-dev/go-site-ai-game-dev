"""
ИИ-ассистент Юра — помогает создавать игры, сайты и ботов.
...
SYSTEM_PROMPT = """Ты — Юра, личный ИИ-разработчик на платформе NEXUS GAME AI.
Ты помогаешь пользователям создавать игры, сайты и ботов без программирования.
Ты дружелюбный, краткий и профессиональный. Говоришь только на русском.
...
Будь краток — не более 3-4 предложений в ответе."""
...
def handler(event: dict, context) -> dict:
    """ИИ-ассистент Юра для создания проектов через диалог."""
    ...
    if action == 'chat':
        ...
        if not has_key:
            demo_reply = (
                "Привет! Я Юра, твой личный разработчик. "
